                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, position: 'relative' }}>
                                <Typography
                                    ...
                                    sx={{
                                        ...
                                        zIndex: 1 // Ensure it's above other elements if they overlap
                                    }}
                                >
                                    Bài viết nổi bật
                                </Typography>
                                            ...
                                            >
                                                ...
                                                <CardContent sx={{ flexGrow: 1, p: 2, display: 'flex', flexDirection: 'column' }}>
                                                    ...
                                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                                        <Avatar
                                                            src={constructUrl(post.authorInfo?.avatarUrl || post.author?.avatarUrl || post.authorId?.avatarUrl)}
                                                ...
                                                >
                                                    ...
                                                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                                        {topic.latestPost ? (
                                                            ...
                                                            >
                                                                <Avatar
                                                                    src={constructUrl(topic.latestPost.authorInfo?.avatarUrl || topic.latestPost.author?.avatarUrl)}
